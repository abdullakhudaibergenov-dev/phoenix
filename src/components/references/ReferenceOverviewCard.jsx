      ...
      <article className="rounded-2xl border border-zinc-800 bg-primary p-6 shadow-card">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-lg font-semibold text-gold">{content.companyName}</h3>
          </div>
        </div>
        <h4 className="mt-5 text-xl font-semibold text-gold">{content.title}</h4>
        <p className="mt-3 text-sm text-zinc-200">{content.subtitle}</p>
