    ...
    <footer className="mt-20 border-t border-zinc-800 bg-primary py-12 text-zinc-200">
      <Container className="grid gap-8 md:grid-cols-3">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-zinc-400">Premium corporate solutions for people, process, and growth.</p>
        </div>

        <div>
          <h5 className="text-sm font-semibold uppercase tracking-wider text-gold">Quick Links</h5>
        ...
        <div>
          ...
          <h5 className="text-sm font-semibold uppercase tracking-wider text-gold">Contact</h5>
