...
function ServicesSection() {
  return (
    <>
      ...
      <section className="bg-white py-20 md:py-24" aria-labelledby="strategic-talent-solutions">
        <Container>
          <div className="grid items-start gap-12 lg:grid-cols-[minmax(0,1.5fr)_minmax(0,1fr)] lg:gap-16">
            <article className="max-w-3xl">
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.26em] text-[#555555]">
                Strategic Talent Solutions
              </p>
              <div className="mb-8 h-px w-28 bg-gradient-to-r from-[#c8a24d]/60 via-[#d9d9d9] to-transparent" />

              <h2
                id="strategic-talent-solutions"
                className="mb-8 text-3xl font-semibold leading-tight text-[#1a1a1a] md:text-4xl"
              >
                Precision recruitment programs built for international employers requiring confident, long-term hiring
                decisions.
              </h2>

              <div className="space-y-6 text-base leading-8 text-[#1a1a1a] md:text-lg">
                <p>
            ...
            <aside className="space-y-6 lg:pt-10" aria-label="Recruitment visuals">
              {recruitmentImages.map((image) => (
                <figure
                  key={image.src}
                  className="group overflow-hidden rounded-md border border-[#e3e3e3] bg-white shadow-[0_16px_30px_rgba(0,0,0,0.10)] transition duration-500 hover:-translate-y-1 hover:border-[#c8a24d]/40 hover:shadow-[0_22px_36px_rgba(0,0,0,0.16)]"
                >
                  ...
                  <figcaption className="border-t border-[#ececec] px-5 py-4 text-sm font-medium uppercase tracking-[0.18em] text-[#555555] transition-colors duration-500 group-hover:text-[#1a1a1a]">
                    {image.caption}
                  </figcaption>
                </figure>
              ))}
