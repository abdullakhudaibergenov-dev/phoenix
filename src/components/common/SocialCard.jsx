function SocialCard({ title, label, image, link, followText }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group relative block min-h-[320px] overflow-hidden rounded-2xl border border-theme shadow-card transition duration-500 ease-out hover:-translate-y-1 hover:scale-[1.03]"
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-between p-7 md:p-8">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-heading">{label}</p>
